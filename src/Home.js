...
function Home() {
  return (
    ...
    <img src={tagline}></img>
    <br></br>  <br></br>
    <a href="phonepe://pay?pa=jhaj9104@okicici&am=100&cu=INR"> <Button variant='warning' style={{width:'20em',height:'4em',borderRadius:'10em',color:'darkblue'}}><b>Send Money</b></Button></a>
